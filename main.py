...
def exe():
    k=messagebox.askquestion("Confirm Exit","Do you Really\n Want to Exit !")
    if k=="yes":
        quit()
...
root = Tk()
root.title("Deepraj's Library")
root.minsize(width=400, height=400)
root.geometry("600x500")
root.wm_iconbitmap(r"Resources/mainicon.ico")
...
btn6 = Button(root, text="Exit Library", bg='black',
              fg='white', command=exe)
